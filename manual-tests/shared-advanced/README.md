...
This supports minimum-vote application in the tested Desktop build. It does not audit every returned title's votes or establish direct Desktop import/export preservation. No repeat test is required before starting the bounded Studio implementation after focused scope/issue approval. People, compound locales and wider client parity remain separate.
