...
test("Workspace routes Network providers through one atomic Add path and Source Edit", () => {
	...
	assert.match(source, /\[MOVIE_FRANCHISE_SOURCE_MODE_ID, PEOPLE_SOURCE_MODE_ID, STUDIO_SOURCE_MODE_ID, NETWORK_SOURCE_MODE_ID, STREAMING_SOURCE_MODE_ID\]\.includes\(modeId\)/);
