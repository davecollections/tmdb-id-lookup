...
runNode(["--test", path.join("tests", "pages-asset-references.test.mjs")]);
...
runNode(["--test", path.join("tests", "decades-artwork.test.mjs")]);
...
runNode([path.join("manual-tests", "collection-preservation", "generate-pack.mjs"), "--check"]);
...
runNode(["--test", path.join("tests", "builder-advanced-discover.test.mjs"), path.join("tests", "builder-advanced-discover-worker.test.mjs"), path.join("tests", "builder-keyword-catalogue.test.mjs")]);
...
runNode(["--test", path.join("tests", "builder-import-merge.test.mjs")]);
...
runNode(["--test", path.join("tests", "builder-export-defaults.test.mjs")]);
...
runNode(["--test", path.join("tests", "builder-source-chooser-ui.test.mjs")]);
