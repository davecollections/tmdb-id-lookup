...
The accepted #206/#207 evidence is reused with its original limits. No Nuvio client retest or exact cross-client result/count parity is claimed; hidden NuvioTV status/current-date behavior is not reproduced. Worker source, routes, allowlists, CORS, CSP, hosts, authentication, V1 and dependencies are unchanged. #213 is uncommitted and awaiting owner/review-chat inspection; it is not merged or published.
