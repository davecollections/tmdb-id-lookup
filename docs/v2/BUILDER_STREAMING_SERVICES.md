...
Issue [#104](https://github.com/davecollections/tmdb-id-lookup/issues/104) added Streaming Services as the fifth selected-folder **Add Source** mode. Issue [#162](https://github.com/davecollections/tmdb-id-lookup/issues/162) adds the separate, owner-approved guided **New Collection** and **New Folder** hierarchy family.
