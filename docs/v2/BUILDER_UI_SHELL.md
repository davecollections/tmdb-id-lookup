...
Status: current Builder shell includes owner-reviewed hierarchy creation through Network issue [#126](https://github.com/davecollections/tmdb-id-lookup/issues/126), whose Worker deployment and live sorted-Preview validation are complete; merge state is tracked by GitHub
...
- `data-creation-option="blank|decades|people|franchises"`
