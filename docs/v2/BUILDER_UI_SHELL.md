...
- Collection menus in Edit / Sort folders / Remove folders / Delete collection order, Folder Edit/Delete menus, Edit source/Delete for supported source families, and Delete-only menus for unsupported sources;
