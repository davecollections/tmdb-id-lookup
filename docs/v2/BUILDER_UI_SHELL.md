...
Status: shell and current creation/source workflows implemented through issue [#113](https://github.com/davecollections/tmdb-id-lookup/issues/113) / PR [#115](https://github.com/davecollections/tmdb-id-lookup/pull/115), including six selected-folder Add Source modes, the Blank/Decades contextual hierarchy launcher, and seven fail-closed physical-source editor adapters
