...
The merged guided hierarchy families are **Decades, People, Franchises, Studios, Networks, and Genres**. Genres merged through issue [#130](https://github.com/davecollections/tmdb-id-lookup/issues/130) / PR [#131](https://github.com/davecollections/tmdb-id-lookup/pull/131) at `817b4b8c46ca135e2badcfc6ca903dde3f824222` after the required owner Worker deployment, production Worker/TMDB/image-CDN validation, and desktop/physical-phone review. **Streaming Services** is the seventh owner-approved family from issue [#162](https://github.com/davecollections/tmdb-id-lookup/issues/162). **TMDB Lists** is the eighth working-tree family from issue [#170](https://github.com/davecollections/tmdb-id-lookup/issues/170); its production Worker deployment, live acceptance, owner review, publication, and merge are still pending. Selected-folder Add Source and physical Source Edit remain separate operations.
