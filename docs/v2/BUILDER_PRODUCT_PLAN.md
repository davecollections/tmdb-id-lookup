...
18. Reuse-first hierarchy-family migration through the existing launcher — People is the first post-Decades proof through issue #118 / PR #119. Issue #120 codifies the shared standard. Franchises merged through issue #122 / PR #123, Studios through issue #124 / PR #125, and Networks through issue #126 / PR #127. Genre issue #130 is implemented but remains unstaged and uncommitted at renewed owner review after its second corrected Worker deployment and live production validation passed.
19. Complete issue #130 through renewed owner review and separately authorized commit/PR/merge gates. Both owner deployment/live-validation rounds remain evidence; the second satisfies the corrected canonical-adult contract.
20. After Genre hierarchy completion, pause new source-family expansion and plan a whole-Builder tightening/consolidation phase. Consider visual and Preview consistency—including the open mobile 10-poster/two-row question—accumulated UX rough edges, safe shared-code opportunities, evidence gaps, unnecessary duplication, and stale/deferred items worth closing. This is a future planning stage, not a pre-created issue list.
21. Advanced Discover.
22. Broader deliberate V2 UI/UX and artwork-runtime integration at appropriate source stages.
23. Quick Setup, templates, and recipe engine after underlying creation flows are reliable.
