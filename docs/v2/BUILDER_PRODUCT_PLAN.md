...
18. Reuse-first hierarchy-family migration through the existing launcher — People is the first post-Decades proof through issue #118 / PR #119. Issue #120 codifies the shared standard. Franchises is implemented and owner-reviewed through issue #122 / PR #123 with exact TMDB Collection identity, one folder/source per selection, and no change to Add Source. Studios is complete and owner-reviewed through issue #124 with explicit lazy Preview, zero automatic hierarchy Discover requests, fixed Landscape artwork, and a manually deployed and live-validated narrow Worker allowlist expansion. Other families remain future work.
