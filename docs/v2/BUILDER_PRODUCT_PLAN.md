...
18. Reuse-first hierarchy-family migration through the existing launcher — People is the merged first post-Decades proof through issue #118 / PR #119. Issue #120 codifies the shared standard. Franchises has completed accepted owner review through issue #122 with exact TMDB Collection identity, one folder/source per selection, and no change to Add Source; it is not yet merged or released. Other families remain future work.
