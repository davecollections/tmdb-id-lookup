...
**Confirmed future creation direction:** the next phase will extend the existing New Collection/New Folder hierarchy launcher to more existing families through reuse-first, family-specific orchestration.
...
18. Reuse-first hierarchy-family migration through the existing launcher.
