...
- **Workspace header/navigation consolidation — owner-deferred UX finding from #261 / PR #262.** Consider a stronger top banner/header with primary actions retained and secondary utilities moved behind an overflow/burger menu, with deliberate desktop/mobile treatment. Consider this before or during launch-readiness assessment. The current header remains acceptable; this records a finding only, with no header redesign, new issue, or implementation authorization in the Find task.
