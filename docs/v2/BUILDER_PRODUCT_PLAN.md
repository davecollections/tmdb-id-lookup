...
11. Native physical-source editing — integrated through issue #78 / PR #79 for Movie Collection and People, then extended through merged Studio issue #92 / PR #93 and Network issue #98 / PR #99 for preservation-safe display-name/sort editing. Discover remains intentionally non-editable in the Core milestone. A complete current-client V2 edit/export round trip is deliberately deferred until V2 exposes export and is not an unfinished integration gate.
