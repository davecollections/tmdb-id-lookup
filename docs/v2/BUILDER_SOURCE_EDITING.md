...
- `decade-editor.js` recognizes only canonical issue #112 Decade periods, owns title/sort/nonstructural-filter validation and difference-only patches, rebuilds a canonical candidate, and keeps period/media/included-Genre structure fixed;
