...
export function SourceElsewhereNotice({
	occurrences,
	visibleLimit = 3,
	heading = "This source exists elsewhere",
	action = "You can still add it to this folder, or close this window to cancel.",
}) {
	...
	return (
		<div className="studio-elsewhere-note source-elsewhere-note" role="status">
			<strong className="studio-elsewhere-heading">{heading}</strong>
			...
			<p className="studio-elsewhere-action">{action}</p>
		</div>
	);
}
