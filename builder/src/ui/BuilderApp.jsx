...
export function BuilderApp({ controller }) {
	...
	return (
		<main className="builder-shell" data-builder-shell="true">
			<header className="app-header">
				<div className="brand-lockup">
					...
					<div>
						...
						<h1>Nuvio Collection Builder</h1>
					</div>
				</div>
			...
			<InlineNotices diagnostic={view.operationDiagnostic} migrationNotice={view.migrationNotice} />
			...
			<div className="workspace" data-mobile-level={view.activeMobileLevel}>
				...
				<section className="workspace-panel folders-panel" data-panel="folders" aria-labelledby="folders-title">
					...
					{view.selectedCollection ? (
						<p className="mobile-context mobile-only">{view.selectedCollection.title}</p>
					) : null}
					<PanelHeader
						id="folders-title"
						title="Folders"
				...
				<section className="workspace-panel sources-panel" data-panel="sources" aria-labelledby="sources-title">
					...
					<div className="panel-body sources-body">
						{!view.selectedFolder ? (
							...
							<EmptyState title="No sources in this folder yet.">
								Source creation will arrive in a later builder step.
							</EmptyState>
						)}
						<SelectionSummary
