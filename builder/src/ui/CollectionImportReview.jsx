	...
	return <>
		...
		{mergePreview && !confirmation && !staleProject ? <>
			...
			{mergePreview.ok ? <section className="nuvio-merge-preview" aria-label="Merge preview" aria-live="polite">
				<ReviewHeading>Merge preview</ReviewHeading><p>Merge: {quantity(mergePreview.counts.collectionsMerged, "Collection")} · {quantity(mergePreview.counts.foldersMerged, "Folder")}</p>
				...
				<ArtworkHeading>Artwork</ArtworkHeading><p data-artwork-counts>{quantity(mergePreview.artworkCounts.kept, "existing field")} kept · {quantity(mergePreview.artworkCounts.filled, "missing field")} filled · {quantity(mergePreview.artworkCounts.replaced, "existing field")} replaced</p>
