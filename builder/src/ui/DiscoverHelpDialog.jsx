  ...
  <div className="discover-help-scroll genre-help-subview" tabIndex={0} aria-label="Discover guide">
   ...
   <details className="genre-advanced-options discover-help-disclosure">
    ...
    <dl>
     ...
     <div><dt>Preview display choices</dt><dd>{editing ? "Preview uses this Source’s current media, sort and filters, including unsaved changes." : "Preview offers only your selected media and Source orders. Show or Media choices appear only when there is more than one option."} Preview does not change your settings.</dd></div>
