...
function statusLabel(status, standalone) {
	...
	if (status === TMDB_LIST_PLACEMENT_STATUSES.EXISTS_ELSEWHERE) return standalone ? "Exists elsewhere · ready to add" : "Exists elsewhere · ready to create";
	return standalone ? "Ready to add" : "Ready to create";
}
