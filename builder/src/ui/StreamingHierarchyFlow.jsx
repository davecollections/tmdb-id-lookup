...
export function StreamingHierarchyFlow({
	...
	async function submit(event) {
		...
		if (step === "configure") {
			if (!chosen.length || !options.sortOptionIds.length || !(scope === "new-collection" ? newCollectionPlanResult : fixedExistingPlanResult)?.ok) return;
